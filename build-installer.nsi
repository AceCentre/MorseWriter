...
Section
    ...
    ;create start-menu items
      CreateDirectory "$SMPROGRAMS\Ace Centre\MorseWriter"
      CreateShortCut "$SMPROGRAMS\Ace Centre\RelayKeys\MorseWriter.lnk" "$INSTDIR\MorseWriter.exe" "" "$INSTDIR\relaykeys-morsewriter.exe" 0
      ...
      CreateShortcut "$DESKTOP\MorseWriter.lnk" "$INSTDIR\MorseWriter.exe"
...
Section Uninstall
    ...
    SetShellVarContext all
    Delete "$SMPROGRAMS\Ace Centre\MorseWriter\MorseWriter.lnk"
    Delete "$SMPROGRAMS\Ace Centre\MorseWriter\Help.lnk"
    Delete "$SMPROGRAMS\Ace Centre\MorseWriter\Uninstall.lnk"
    Delete "$DESKTOP\MorseWriter.lnk"
    RMDir /r "$INSTDIR"
SectionEnd
